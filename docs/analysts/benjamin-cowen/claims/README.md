---
id: ARES-KB-benjamin-cowen-claims
title: Benjamin Cowen: Claims
...
Artifacts in this directory use the [claim template](../../../templates/claim.md) and must satisfy the [specifications](../../../specifications/README.md). Empty by design.
