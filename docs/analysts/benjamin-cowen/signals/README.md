---
id: ARES-KB-benjamin-cowen-signals
title: Benjamin Cowen: Signals
...
Artifacts in this directory use the [signal template](../../../templates/signal.md) and must satisfy the [specifications](../../../specifications/README.md). Empty by design.
