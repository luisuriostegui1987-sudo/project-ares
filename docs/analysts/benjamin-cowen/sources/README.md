---
id: ARES-KB-benjamin-cowen-sources
title: Benjamin Cowen: Source records
...
Artifacts in this directory use the [source-record template](../../../templates/source-record.md) and must satisfy the [specifications](../../../specifications/README.md). Empty by design.
