---
id: ARES-KB-chris-camillo-validation
title: Chris Camillo: Validation records
...
# Chris Camillo — Validation records
...
Artifacts in this directory use the [validation-record template](../../../templates/validation-record.md) and must satisfy the [specifications](../../../specifications/README.md). Empty by design.
