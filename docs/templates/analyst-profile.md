---
id: ARES-TPL-ANALYST
title: Template: Analyst profile
...
- **analyst_id**
- **scope_of_research** — what is and is not covered
- **authorization** — date and record of Luis's explicit authorization
- **primary_sources_overview** — tiers available
- **methodology_notes** — how THIS analyst's material maps to the phases
- **known_limitations**
- **unknowns**
